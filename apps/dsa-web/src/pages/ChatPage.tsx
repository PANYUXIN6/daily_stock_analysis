...
const QUICK_QUESTIONS: Array<{
  ...
  { label: '分析宁德时代 300750', skill: 'bull_trend', stockContext: { stock_code: '300750', stock_name: '宁德时代' } },
...
const ChatPage: React.FC = () => {
  ...
  const handleSend = useCallback(
    async (
      ...
      const stockResolution = resolveActiveStockContextFromMessage(msgText, activeStockContext, stockIndex);
      if (stockResolution) {
