...
class ComputeEffectiveRegionTestCase(unittest.TestCase):
    ...
    def test_comma_subset_no_supported_tokens_falls_back_to_cn(self):
        result = trading_calendar.compute_effective_region("eu,xx", {"cn", "cn"})
    ...
    def test_single_region_open(self):
        self.assertEqual(trading_calendar.compute_effective_region("cn", {"cn", "cn", "cn"}), "cn")

    def test_single_region_closed(self):
        self.assertEqual(trading_calendar.compute_effective_region("cn", set()), "")
