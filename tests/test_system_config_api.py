...
class SystemConfigApiTestCase(unittest.TestCase):
    ...
    def test_get_config_keeps_regular_secret_value_unmasked(self) -> None:
        ...
        self.assertEqual(item_map["DEEPSEEK_API_KEY"]["value"], "secret-key-value")
        self.assertFalse(item_map["DEEPSEEK_API_KEY"]["is_masked"])
    ...
    def test_put_config_updates_secret_and_plain_field(self) -> None:
        ...
        payload = system_config.update_system_config(
            request=UpdateSystemConfigRequest(
                ...
                reload_now=False,
                items=[
                    {"key": "DEEPSEEK_API_KEY", "value": "new-secret-value"},
        ...
        self.assertIn("DEEPSEEK_API_KEY=new-secret-value", env_content)
    ...
    def test_import_system_config_merges_updates(self) -> None:
        ...
        self.assertIn("DEEPSEEK_API_KEY=secret-key-value\n", env_content)
